...
export default function SavingsOverview({ totalSimpanan, totalPenarikan, netSimpanan }) {
	return (
		<div className="grid sm:grid-cols-3 gap-4">
			<div className="rounded-[1.75rem] bg-[#0F172A] px-6 py-7 shadow-lift">
				<p className="text-[12px] text-white/60 font-medium mb-2">Total Simpanan</p>
			...
			<div className="rounded-2xl bg-white border border-[#D8E4EA] shadow-soft p-5">
				<p className="text-[12px] text-[#94A3B8] font-medium mb-2">Total Penarikan</p>
			...
			<div className="rounded-2xl bg-white border border-[#D8E4EA] shadow-soft p-5">
				<p className="text-[12px] text-[#94A3B8] font-medium mb-2">Saldo Bersih</p>
