		...
		<div className="rounded-lg bg-white border border-[#E5E7EB] p-5">
			...
			<div className="space-y-6">
				<div>
					<div className="flex justify-between items-end mb-2">
						<div className="flex items-center gap-2">
							<span className="w-3 h-3 rounded-lg bg-[#22C55E]"></span>
					...
					<div className="h-5 rounded-lg bg-[#F1F5F9] overflow-hidden">
						<div
							className="h-full rounded-lg bg-[#22C55E] transition-all duration-700"
				...
				<div>
					<div className="flex justify-between items-end mb-2">
						<div className="flex items-center gap-2">
							<span className="w-3 h-3 rounded-lg bg-[#EF4444]"></span>
							<span className="text-[13px] font-medium text-[#0F172A]">
								Pengeluaran
							</span>
						</div>
					...
					<div className="h-5 rounded-lg bg-[#F1F5F9] overflow-hidden">
						<div
							className="h-full rounded-lg bg-[#EF4444] transition-all duration-700"
				...
				<div className="pt-4 border-t border-[#E8EEF2]">
					<div className="flex items-center justify-between">
						...
						<span
							className={`text-[14px] font-bold ${totalIncome >= totalExpense ? "text-[#22C55E]" : "text-[#EF4444]"}`}
						>
