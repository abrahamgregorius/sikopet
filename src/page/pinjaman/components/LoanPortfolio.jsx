...
export default function LoanPortfolio({ totalOutstanding, totalPending, activeCount, completedCount }) {
	return (
		<div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
			<div className="rounded-2xl bg-white border border-[#D8E4EA] shadow-soft p-5">
				<p className="text-[12px] text-[#94A3B8] font-medium mb-2">Total Outstanding</p>
				...
				<div className="flex items-center gap-1.5 mt-2">
					<span className="w-2 h-2 rounded-full bg-[#398EB3]"></span>
			...
			<div className="rounded-2xl bg-white border border-[#D8E4EA] shadow-soft p-5">
				<p className="text-[12px] text-[#94A3B8] font-medium mb-2">Pinjaman Aktif</p>
				<p className="font-display font-extrabold text-[#0F172A] text-[24px] sm:text-[28px] tracking-tight">
					{activeCount}
				</p>
				<div className="flex items-center gap-1.5 mt-2">
