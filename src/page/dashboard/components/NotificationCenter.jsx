...
const ICONS = {
	info: (
		<path
			d="M12 9v4M12 17h.01M10.3 3.9L2 20h20L13.7 3.9a2 2 0 00-3.4 0z"
			strokeLinecap="round"
	...
	error: (
		<path
			d="M12 8v4M12 16h.01M10.3 3.9L2 20h20L13.7 3.9a2 2 0 00-3.4 0z"
			strokeLinecap="round"
			strokeLinejoin="round"
		/>
	),
				...
				<div className="space-y-3.5">
					{[1, 2, 3].map((i) => (
						<div key={i} className="flex gap-3">
							<div className="w-8 h-8 rounded-lg skel shrink-0"></div>
				...
				{notifications.map((n) => {
					...
					return (
						<li key={n.id} className="flex gap-3">
							<span
								className={`w-8 h-8 shrink-0 rounded-lg ${c.bg} grid place-items-center`}
							>
								<svg
									width="14"
									height="14"
