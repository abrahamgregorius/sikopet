...
const docs = [
	{ name: "Laporan RAT 2025.pdf", meta: "2.4 MB · 2 hari lalu", bg: "bg-[#EAF6FB]", stroke: "#398eb3" },
	{ name: "Neraca Q2 2026.xlsx", meta: "860 KB · 4 hari lalu", bg: "bg-[#4CC9B0]/15", stroke: "#2F7698" },
	{ name: "Kebijakan Simpan Pinjam.docx", meta: "410 KB · 1 minggu lalu", bg: "bg-[#F59E0B]/15", stroke: "#F59E0B" },
];
				...
				{docs.map((doc) => (
					<li key={doc.name} className="flex items-center gap-3">
						<IconContainer size="md" className={doc.bg}>
							<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={doc.stroke} strokeWidth="1.8"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" /><path d="M14 2v6h6" strokeLinejoin="round" /></svg>
						</IconContainer>
