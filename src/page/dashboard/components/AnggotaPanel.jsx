  ...
  return (
    <section id="anggota-panel" className="reveal in rounded-3xl bg-gradient-to-br from-[#EAF6FB] to-white border border-[#D8E4EA] p-6 sm:p-7">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h3 className="font-display font-bold text-[#0F172A] text-[17px]">Data Anggota</h3>
          <p className="text-[13px] text-[#475569] mt-1">Statistik anggota cooperative</p>
        </div>
      ...
      <div className="grid sm:grid-cols-3 gap-4 mt-6">
        <div className="rounded-2xl bg-white/70 border border-white p-4">
          <p className="text-[12px] text-[#94A3B8] font-medium">Total Anggota</p>
        ...
        <div className="rounded-2xl bg-white/70 border border-white p-4">
          <p className="text-[12px] text-[#94A3B8] font-medium">Anggota Aktif</p>
          <p className="font-display font-bold text-[#0F172A] text-[19px] mt-1">
        ...
        <div className="rounded-2xl bg-white/70 border border-white p-4">
          <p className="text-[12px] text-[#94A3B8] font-medium">Baru Bulan Ini</p>
          <p className="font-display font-bold text-[#0F172A] text-[19px] mt-1">
