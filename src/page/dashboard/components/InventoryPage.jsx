...
export default function InventoryPage() {
    ...
    return (
        <div className="space-y-6">
            ...
            {lowStockCount > 0 && (
                <div className="rounded-xl bg-[#FEF3C7] border border-[#FCD34D] px-4 py-3 flex items-center gap-3">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#F59E0B" strokeWidth="2">
                        <path d="M12 9v4M12 17h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.7 3.86a2 2 0 00-3.42 0z" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                    <p className="text-[13px] text-[#92400E] font-medium">
                        <span className="font-bold">{lowStockCount}</span> produk stock rendah
                    </p>
                </div>
            )}
            ...
            <div className="rounded-2xl bg-white border border-[#D8E4EA] overflow-hidden">
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-48 text-center px-6">
                        ...
                        <p className="text-[14px] text-[#94A3B8]">Tidak ada produk ditemukan</p>
                    </div>
                ) : (
                                ...
                                {filteredProducts.map((product) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className="px-5 py-4">
                                                <span className="inline-flex px-2.5 py-1 rounded-full text-[11px] font-semibold bg-[#F1F5F9] text-[#475569]">
                                                    {product.category}
                                                </span>
                                            </td>
            ...
            {adjustModal && (
                <>
                    <div onClick={() => setAdjustModal(null)} className="fixed inset-0 bg-[#0F172A]/40 z-[80]" />
                    <div className="fixed inset-0 z-[90] grid place-items-center px-4">
                        <div className="w-full max-w-[380px] bg-white rounded-3xl shadow-lift p-6 sm:p-7">
                            <div className="flex items-center justify-between mb-5">
                                <h3 className="font-display font-bold text-[18px] text-[#0F172A]">
                                    Adjust Stock
                                </h3>
                            ...
                            <div className="mb-4 p-3 rounded-xl bg-[#F1F5F9]">
                                <p className="font-medium text-[14px] text-[#0F172A]">
                                    {adjustModal.name}
                                </p>
                            ...
                            <form onSubmit={handleAdjust} className="space-y-4">
                                <div className="grid grid-cols-2 gap-3">
                                    <button
                                        ...
                                        className={`h-[48px] rounded-xl font-semibold text-[14px] transition-colors ${
                                            adjustForm.type === "in"
                                ...
                                <button
                                    type="submit"
                                    className="focus-ring w-full h-[46px] rounded-full bg-[#398eb3] text-white font-semibold text-[14px] hover:bg-[#2F7A9A] transition-colors shadow-glow"
                                >
                                    Konfirmasi
                                </button>
                            </form>
            ...
            {toast && (
                <div
                    className={`fixed bottom-6 right-6 z-[100] px-5 py-3 rounded-2xl shadow-lift flex items-center gap-3 animate-pop-in ${
                        toast.type === "success"
                            ? "bg-[#22C55E] text-white"
                            : "bg-[#EF4444] text-white"
                    }`}
