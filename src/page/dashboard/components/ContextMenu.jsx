	...
	return (
		...
		>
			...
			{actions.map((action) => (
				<button
					key={action.label}
					className={`focus-ring w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-[13px] transition-colors ${action.danger ? "text-[#EF4444] hover:bg-[#EF4444]/10" : "text-[#475569] hover:bg-[#F1F5F9]"}`}
				>
					<svg
						width="14"
						height="14"
