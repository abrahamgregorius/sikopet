...
export default function GenericModulePage() {
    ...
    const displayName = moduleKey?.replace(/-/g, ' ').replace(/\b\w/g, c => c.toUpperCase()) || 'Module';
            ...
            <div className="flex min-h-screen">
                ...
                <div className="flex-1 min-w-0 flex flex-col">
                    ...
                    <main className="flex-1 min-w-0 px-4 sm:px-6 lg:px-8 py-7 space-y-6">
                        <Breadcrumb />
                        <div className="rounded-2xl bg-white border border-[#D8E4EA] p-8 text-center">
                            <div className="w-16 h-16 rounded-2xl bg-[#EAF6FB] grid place-items-center mx-auto mb-4">
                                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#398eb3" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
