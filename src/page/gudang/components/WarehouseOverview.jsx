...
export default function WarehouseOverview({ totalItems, totalStock, lowStockCount }) {
	return (
		<div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
			<div className="rounded-2xl bg-white border border-[#D8E4EA] shadow-soft p-5">
				<div className="flex items-center gap-3 mb-3">
					<span className="w-10 h-10 rounded-xl bg-[#EAF6FB] grid place-items-center">
				...
				<p className="font-display font-extrabold text-[#0F172A] text-[28px] tracking-tight">{totalItems}</p>
				<p className="text-[11px] text-[#94A3B8] mt-1">Jenis produk berbeda</p>
			</div>

			<div className="rounded-2xl bg-white border border-[#D8E4EA] shadow-soft p-5">
				<div className="flex items-center gap-3 mb-3">
					<span className="w-10 h-10 rounded-xl bg-[#DCFCE7] grid place-items-center">
				...
				<p className="font-display font-extrabold text-[#0F172A] text-[28px] tracking-tight">{totalStock.toLocaleString("id-ID")}</p>
				<p className="text-[11px] text-[#94A3B8] mt-1">Unit keseluruhan</p>
			</div>

			<div className="rounded-[1.75rem] bg-[#0F172A] px-6 py-7 shadow-lift">
				<div className="flex items-center gap-3 mb-3">
					<span className="w-10 h-10 rounded-xl bg-white/10 grid place-items-center">
				...
				<p className="font-display font-extrabold text-white text-[28px] tracking-tight">{lowStockCount}</p>
