...
export default function SalesOverview({ totalSales, totalPending, transactionCount, avgTransaction }) {
	return (
		<div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
			<div className="rounded-2xl bg-white border border-[#D8E4EA] shadow-soft p-5">
				<p className="text-[12px] text-[#94A3B8] font-medium mb-2">Total Penjualan</p>
			...
			<div className="rounded-2xl bg-white border border-[#D8E4EA] shadow-soft p-5">
				<p className="text-[12px] text-[#94A3B8] font-medium mb-2">Menunggu Pembayaran</p>
			...
			<div className="rounded-2xl bg-white border border-[#D8E4EA] shadow-soft p-5">
				<p className="text-[12px] text-[#94A3B8] font-medium mb-2">Jumlah Transaksi</p>
				<p className="font-display font-extrabold text-[#398EB3] text-[24px] sm:text-[28px] tracking-tight">{transactionCount}</p>
				<p className="text-[11px] text-[#94A3B8] mt-1">Transaksi</p>
			</div>

			<div className="rounded-[1.75rem] bg-[#0F172A] px-6 py-7 shadow-lift">
				<p className="text-[12px] text-white/60 font-medium mb-2">Rata-rata Transaksi</p>
