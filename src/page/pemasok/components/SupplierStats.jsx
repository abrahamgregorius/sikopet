	...
	return (
		<div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
			<div className="rounded-2xl bg-white border border-[#D8E4EA] shadow-soft p-5">
				<p className="text-[12px] text-[#94A3B8] font-medium mb-2">Total Pemasok</p>
			...
			<div className="rounded-2xl bg-white border border-[#D8E4EA] shadow-soft p-5">
				...
				<p className="font-display font-extrabold text-[#F59E0B] text-[28px] tracking-tight">{pending}</p>
