...
export const MODULE_REGISTRY = [
    ...
    },
    {
        ...
        order: 4,
        nested: [
            { key: "journal", label: "Jurnal Umum", route: "#transaksi" },
            { key: "balance", label: "Neraca", route: "#transaksi" },
            { key: "shu", label: "Laporan SHU", route: "#transaksi" },
        ],
    },
    {
        key: "cashier",
